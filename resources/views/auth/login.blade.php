...
<!-- Mirrored from techzaa.in/larkon/admin/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 02:16:44 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
                                   ...
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        <div class="auth-logo mb-4">
                                             <a href="index.html" class="logo-dark">
                                                  <img src="{{ asset('assetsa/images/logo-dark.png') }}" height="24" alt="logo dark">
                                             </a>

                                             <a href="index.html" class="logo-light">
                                                  <img src="{{ asset('assetsa/images/logo-light.png') }}" height="24" alt="logo light">
                                             </a>
                                        </div>
                    ...
                    <div class="col-xxl-5 d-none d-xxl-flex">
                         <div class="card h-100 mb-0 overflow-hidden">
                              <div class="d-flex flex-column h-100">
                                   <img src="{{ asset('assetsa/images/small/img-10.jpg') }}" alt="" class="w-100 h-100">
                              </div>
                         </div>
                    </div>
               </div>
