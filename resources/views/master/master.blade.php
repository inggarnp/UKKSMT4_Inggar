...
<!-- Mirrored from mixdesign.club/themeforest/braxton/index-solid-color.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 02:13:27 GMT -->
...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/assets/img/favicon/favicon.ico') }}" sizes="any">
    ...
    <meta property="og:image" content="{{ asset('assets/img/favicon/og-image.html') }}">
        ...
        <div class="avatar__block">
          <div class="avatar__logo d-flex align-items-center">
            <div class="logo__image">
              <!-- Your Logo Here!!! -->
              <!--<assets/img src="assets/img/logo.svg" alt="Braxton - Personal Portfolio & Resume HTML Template Logo">-->
          ...
          <div class="avatar__image">
            <img src="{{ ('assets/img/avatars/1024x1024_a03.webp') }}" alt="Braxton - Personal Portfolio & Resume HTML Template Avatar">
          </div>
        </div>
        <!-- data caption #1 -->
        <div class="avatar__block">
            ...
            <div class="container-fluid px-0 inner__gallery">
              <div class="row gx-0 my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                ...
                <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="{{ asset('assets/img/works/1400x1400_w01.webp') }}" data-image="{{ asset('assets/img/works/1400x1400_w01.webp" class="gallery__link" itemprop="contentUrl" data-size="1400x1400">
                    <img src="assets/img/works/800_w01-thumb.webp" class="gallery__image" itemprop="thumbnail" alt="Image description">
                  </a>
                ...
                <!-- Works Gallery Single Item Start -->
                <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="assets/img/works/1400x1400_w02.webp" data-image="assets/img/works/800_w02-thumb.webp" class="gallery__link" itemprop="contentUrl" data-size="1400x1400">
                    <assets/img src="assets/img/works/800_w02-thumb.webp" class="gallery__image" itemprop="thumbnail" alt="Image description">
                  </a>
                ...
                <!-- Works Gallery Single Item Start -->
                <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="assets/img/works/1400x1400_w03.webp" data-image="assets/img/works/800_w03-thumb.webp" class="gallery__link" itemprop="contentUrl" data-size="1400x1400">
                    <assets/img src="assets/img/works/800_w03-thumb.webp" class="gallery__image" itemprop="thumbnail" alt="Image description">
                  </a>
                  <figcaption class="gallery__descr opposite" itemprop="caption description">
                ...
                <!-- Works Gallery Single Item Start -->
                <figure class="col-12 col-md-6 gallery__item grid-item animate-card-2" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="assets/img/works/1400x1400_w04.webp" data-image="assets/img/works/800_w04-thumb.webp" class="gallery__link" itemprop="contentUrl" data-size="1400x1400">
                    <assets/img src="assets/img/works/800_w04-thumb.webp" class="gallery__image" itemprop="thumbnail" alt="Image description">
                  </a>
                  <figcaption class="gallery__descr " itemprop="caption description">
                    <h5>Smart Penguin</h5>
                    <div class="card__tags d-flex flex-wrap">
              ...
              <div class="row g-0 align-items-stretch cards">
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    ...
                    <div class="cards__image d-flex animate-in-up">
                      <assets/img src="assets/img/services/1200x900_s01.webp" alt="Service/Feature Image">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    ...
                    <div class="cards__image d-flex animate-in-up">
                      <assets/img src="assets/img/services/1200x900_s02.webp" alt="Service/Feature Image">
                    </div>
                  </div>
                </div>
                <!-- services grid cards single item -->
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    ...
                    <div class="cards__image d-flex">
                      <assets/img src="assets/img/services/1200x900_s03.webp" alt="Service/Feature Image">
                    </div>
                  </div>
                </div>
                <!-- services grid cards single item -->
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    ...
                    <div class="cards__image d-flex animate-in-up">
                      <assets/img src="assets/img/services/1200x900_s04.webp" alt="Service/Feature Image">
                    </div>
                  </div>
                </div>
        ...
        <section id="resume" class="inner resume">
          ...
          <div class="content__block grid-block block-large">
            ...
            <div class="tools-cards d-flex justify-content-start flex-wrap">
              <!-- tools sassets/imgle item -->
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-photoshop.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-figma.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-illustrator.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-scketch.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-blender.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-html.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-css.svg" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <assets/img class="tools-cards__icon animate-in-up" src="assets/img/icons/icon-notion.svg" alt="Tools Icon">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonials-card animate-in-up">
                      <div class="testimonials-card__tauthor d-flex animate-in-up">
                        <div class="tauthor__avatar">
                          <assets/img src="assets/img/avatars/400x400_t01.webp" alt="Review Author">
                        </div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonials-card  animate-in-up">
                      <div class="testimonials-card__tauthor d-flex  animate-in-up">
                        <div class="tauthor__avatar">
                          <assets/img src="assets/img/avatars/400x400_t02.webp" alt="Review Author">
                        </div>
                        <div class="tauthor__info d-flex flex-column justify-content-center">
...
<!-- Mirrored from mixdesign.club/themeforest/braxton/index-solid-color.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 02:13:39 GMT -->
</html>